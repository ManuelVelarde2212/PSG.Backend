...
print (@IdSesion)
insert into TSesionTutoria values(@IdSesion,@IdFichaTutoria, @Fecha,@TipoTutoria,@Semestre, @Descripcion,@Observaciones)
end;
go
create procedure spuEstudiantebyAsignacion @CodDocente varchar(7)
as begin 
